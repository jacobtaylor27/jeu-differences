...
describe('EventMessage Service', () => {
    ...
    it('Should return a multiplayer difference found message with the player name if exists and if its a multiplayer game', () => {
        const userName = 'user';
        const expectedResult = `Difference trouvée par ${userName} a ${new Date().toLocaleString('en-US', { timeZone: 'America/New_York' })}`;
    ...
    it('Should return a solo difference found message with the player name if exists and if its solo game', () => {
        const userName = 'user';
        const expectedResult = `Difference trouvée a ${new Date().toLocaleString('en-US', { timeZone: 'America/New_York' })}`;
    ...
    it('Should return a multiplayer difference not found message with the player name if exists and if its a multiplayer game', () => {
        const userName = 'user';
        const expectedResult = `Erreur par ${userName} a ${new Date().toLocaleString('en-US', { timeZone: 'America/New_York' })}`;
    ...
    it('Should return a solo difference not found message with the player name if exists and if its a solo game', () => {
        const userName = 'user';
        const expectedResult = `Erreur a ${new Date().toLocaleString('en-US', { timeZone: 'America/New_York' })}`;
    ...
    it('Should return a leaving game message if username exists ', () => {
        const userName = 'user';
        const expectedResult = `${userName} a abandonné la partie a ${new Date().toLocaleString('en-US', { timeZone: 'America/New_York' })}`;
